...
from api_essentials.auth import OAuth2Flow, ClientCredentials
...
async def main():
    ...
    my_api = APIFactory.from_openapi(openapi_spec, auth=OAuth2Flow(r"https://login.bisnode.com/sandbox/v1/token.oauth2"), verify=False)
